...
Ext.define('Shopware.apps.CrefoOrders.view.list.List', {
    ...
    listeners: {
        afterrender: function () {
            var me = this;
            me.fireEvent('loadCollectionData', me);
        },
    ...
    initComponent: function() {
        ...
        me.collectionCreditors = Ext.create('Shopware.apps.CrefoConfiguration.store.inkasso.InkassoCreditors');
        me.collectionValues = Ext.create('Shopware.apps.CrefoConfiguration.store.inkasso.InkassoValues');
    ...
    createActionColumn: function() {
        ...
        me.actionColumn.on('beforerender', function(column, eOpts) {
            ...
            me.hasInkassoConfig = Ext.isDefined(config) && Ext.isDefined(config.UserAccount) && !Ext.isEmpty(config.UserAccount.get('id'));
        });
    ...
    createCreateProposal: function() {
        ...
        return {
            ...
            getClass: function(value, meta, record) {
                if ((Ext.isDefined(record.get('collectionId')) && record.get('collectionId') !== null) || me.hasInkassoConfig === false) {
                    return 'x-hidden';
                } else {
                    return 'x-grid-icon';
                }
