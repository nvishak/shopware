...
Ext.define('Shopware.apps.CrefoConfiguration.view.tabs.reportprivateperson.products.BonimaPoolIdentPremiumContainer',
    {
        ...
        autoShow: true,
        alias: 'widget.crefo-bonima-pool-ident-premium-container',
        name: 'bonimaPoolIdentPremiumContainer',
        itemId: 'bonimaPoolIdentPremiumContainer',
        border: 0,
        layout: 'column',
        defaults: {
            columnWidth: 0.10,
        ...
        createScoreIdentificationResultCol: function (identifier) {
            var me = this,
                html;
            switch (identifier) {
            case 2: html = me.snippets.labels.col.values.personIdentified;
                break;
            case 3: html = me.snippets.labels.col.values.householdIdentified;
                break;
            case 4: html = me.snippets.labels.col.values.buildingIdentified;
                break;
            case 5: html = me.snippets.labels.col.values.personNotIdentified;
                break;
            }
            return {
                xtype: 'text',
