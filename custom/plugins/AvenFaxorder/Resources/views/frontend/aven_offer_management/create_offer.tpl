        ...
        <form class="panel register--form" method="post" action="{url action=saveFaxOrder}">
            <div>
                <fieldset>
                    ...
                    <label>First Name<input name="name" class="register--field" value="{$firstName}" required></label>
                    <label>Last Name<input name="Surnmae" class="register--field" value="{$lastName}" required></label>
                </fieldset>
            </div>
            <div>
                <fieldset>
