<?php /* Smarty version Smarty-3.1.12, created on 2018-04-11 08:19:36
         compiled from "E:\wamp\www\shopware4\themes\Backend\ExtJs\backend\article\controller\variant.js" */ ?>
<?php /*%%SmartyHeaderCode:262155acda8f883c805-96233513%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a0de7ddbdf71c425e5eb11dedb5de30470573b37' => 
    array (
      0 => 'E:\\wamp\\www\\shopware4\\themes\\Backend\\ExtJs\\backend\\article\\controller\\variant.js',
      1 => 1522728756,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '262155acda8f883c805-96233513',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5acda8f8bf1334_70263845',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5acda8f8bf1334_70263845')) {function content_5acda8f8bf1334_70263845($_smarty_tpl) {?>/**
 * Shopware 5
...
'
    ...
    onLoadConfiguratorSet: function(newConfiguratorSet, window) {
        ...
        if (listing.getStore() && listing.getStore().getCount() > 0) {
            Ext.MessageBox.confirm(me.snippets.messages.warningTitle, me.snippets.messages.loadSetWarning, function (response) {
                if ( response === 'yes' ) {
                    Ext.Ajax.request({
                        url:'<?php echo '/shopware4/backend/Article/deleteAllVariants';?>',
                        params:{
                            articleId: me.subApplication.article.get('id')
                        },
                        success: function(record, operation) {
    ...
    */
    ...
    generateNumbers: function(offset, window, totalCount, batchSize, progressbar) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware4/backend/Article/regenerateVariantOrderNumbers';?>',
            method: 'POST',
            params: {
                articleId: me.subApplication.article.get('id'),
                offset: offset,
