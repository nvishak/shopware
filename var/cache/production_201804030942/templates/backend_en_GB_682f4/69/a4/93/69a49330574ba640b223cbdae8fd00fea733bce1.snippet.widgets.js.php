<?php /* Smarty version Smarty-3.1.12, created on 2018-04-11 08:19:25
         compiled from "E:\wamp\www\shopware4\themes\Backend\ExtJs\backend\index\controller\widgets.js" */ ?>
<?php /*%%SmartyHeaderCode:325325acda8ed3fba01-67926635%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '69a49330574ba640b223cbdae8fd00fea733bce1' => 
    array (
      0 => 'E:\\wamp\\www\\shopware4\\themes\\Backend\\ExtJs\\backend\\index\\controller\\widgets.js',
      1 => 1522728756,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '325325acda8ed3fba01-67926635',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5acda8ed4a24a7_73178798',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5acda8ed4a24a7_73178798')) {function content_5acda8ed4a24a7_73178798($_smarty_tpl) {?>/**
 * Shopware 5
...
<?php $_tmp1=ob_get_clean();?><?php if ($_tmp1){?>*/
    ...
    onSaveWidgetPosition: function (column, row, internalId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware4/backend/widgets/savePosition';?>',
            params: {
                column: column,
                position: row,
                id: internalId
    ...
    onSaveWidgetPositions: function (widgets) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware4/backend/widgets/savePositions';?>',
            jsonData: {
                widgets: widgets
            },
    ...
    onAddWidget: function (win, widgetName, menuItem) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware4/backend/widgets/addWidgetView';?>',
            jsonData: {
                id: widget.get('id'),
                column: 0,
    ...
    onCloseWidget: function (widget) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware4/backend/widgets/removeWidgetView';?>',
            params: {
                id: widget.viewId
            },
            callback: function (options, success, res) {
    ...
    onOpenMerchantDetail: function (mode, record) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware4/backend/widgets/requestMerchantForm';?>',
            params: {
                id: ~~(1 * record.get('id')),
