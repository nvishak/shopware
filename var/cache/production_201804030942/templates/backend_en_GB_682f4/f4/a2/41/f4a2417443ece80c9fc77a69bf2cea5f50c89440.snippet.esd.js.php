<?php /* Smarty version Smarty-3.1.12, created on 2018-04-11 08:19:37
         compiled from "E:\wamp\www\shopware4\themes\Backend\ExtJs\backend\article\controller\esd.js" */ ?>
<?php /*%%SmartyHeaderCode:32615acda8f9231b16-08380045%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f4a2417443ece80c9fc77a69bf2cea5f50c89440' => 
    array (
      0 => 'E:\\wamp\\www\\shopware4\\themes\\Backend\\ExtJs\\backend\\article\\controller\\esd.js',
      1 => 1522728756,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '32615acda8f9231b16-08380045',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_5acda8f9378f61_17187889',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5acda8f9378f61_17187889')) {function content_5acda8f9378f61_17187889($_smarty_tpl) {?>/**
 * Shopware 5
...
'
    ...
    onAddEsd: function(articleDetailId) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware4/backend/Article/createEsd';?>',
            method: 'POST',
            params: {
    ...
    saveNewSerials: function(serials) {
        ...
        Ext.Ajax.request({
            url: '<?php echo '/shopware4/backend/Article/saveSerials';?>',
            method: 'POST',
            params: {
    ...
    onDeleteUnusedSerials: function() {
        ...
        Ext.MessageBox.confirm(me.snippets.growlMessage, me.snippets.messages.serialsRemoveUnused , function (response) {
            ...
            Ext.Ajax.request({
                url: '<?php echo '/shopware4/backend/Article/deleteUnusedSerials';?>',
                method: 'POST',
                params: {
                    esdId: me.detailWindow.esdRecord.get('id')
                },
    ...
    onDownloadFile: function() {
        ...
        var url = '<?php echo '/shopware4/backend/Article/getEsdDownload';?>' + '/filename/' + record.get('file');
